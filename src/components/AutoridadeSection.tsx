...
const NOS = [
  ...
  },
  {
    ...
    text: "Hospital Professor Edmundo Vasconcelos",
  },
  {
    icon: (
      <svg
    ...
    label: "Fellowship",
    text: "Cirurgia Robótica  Hospital Israelita Albert Einstein \n Cirurgia Robótica e Laser na Clinique Saint Augustin - França \n  Uro-oncologia USP e Prof. Miguel Srougi",
  },
  {
    icon: (
      <svg
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[480px_1fr] gap-10 lg:gap-16 items-start">
        ...
        <div className="relative" data-aos="fade-right" data-aos-delay="100">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, transparent, #f5c518 25%, #f5c518 75%, transparent)",
            }}
          />
        ...
        >
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "rgba(255,255,255,0.5)", maxWidth: 620 }}
            >
              Urologista com mais de 21 anos de experiência, referência em
              Fortaleza no tratamento de doenças prostáticas e cirurgias
              urológicas minimamente invasivas.Pioneiro na enucleação da
              próstata a laser (HoLEP) e Cirúrgia Robotica no Nordeste, com atuação focada em
              técnicas avançadas e baseadas em evidências científicas
              internacionais.
            </p>
          </div>
          ...
          >
            ...
            >
              Mais do que operar, minha missão é que você entenda cada etapa do
              tratamento e se sinta{" "}
              <span style={{ color: "#f5c518" }}>
                completamente seguro antes, durante e depois.
              </span>
            </p>
          </div>
        </div>
